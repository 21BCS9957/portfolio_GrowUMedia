...
const plans = [
  {
    name: "Standard",
    description:
      "Perfect for basic video editing needs with skilled editors",
    price: 600,
    yearlyPrice: 7000,
    buttonText: "Explore",
    buttonVariant: "outline" as const,
    link: "/editors/standard",
    includes: [
      "Experience Level:",
      "6 months professional editing",
  ...
  },
  {
    name: "Premium",
    description:
      "Advanced editing with creative storytelling and professional polish",
    price: 1200,
    yearlyPrice: 14000,
    buttonText: "Explore",
    buttonVariant: "default" as const,
    popular: true,
    link: "/editors/premium",
    includes: [
      "Experience Level:",
      "1 year professional editing",
  ...
  },
  {
    name: "Premium+",
    description:
      "Expert-level editing with cinematic quality and advanced techniques",
    price: 2200,
    yearlyPrice: 21000,
    buttonText: "Explore",
    buttonVariant: "outline" as const,
    link: "/editors/premium-plus",
    includes: [
      "Experience Level:",
    ...
    >
      ...
      <article className="text-center mb-6 pt-32 max-w-3xl mx-auto space-y-2 relative z-50">
        <h2 className="text-4xl font-medium text-white">
          ...
          >
            Hire Professional Video Editors
          </VerticalCutReveal>
        </h2>
        <TimelineContent
          as="p"
        ...
        >
          Choose from our talented pool of video editors with varying experience levels.
          Explore their work and find the perfect match for your project.
        </TimelineContent>
        <TimelineContent
          as="div"
          animationNum={1}
          ...
          >
            ...
            >
              ...
              <CardContent className="pt-0">
                <Link href={plan.link}>
                  <button
                    className={`w-full mb-6 p-4 text-xl rounded-xl transition-all hover:scale-105 ${
                      plan.popular
